...
def receiver():
    ...
    if event_type == "push":
        ...
        doc.update({
            ...
            "from_branch": "",
            "to_branch": to_branch,
            "message": f"<b>{author}</b> pushed to <b>{to_branch}</b> on {readable_timestamp}"
    ...
    # PULL REQUEST event
        ...
        if action == "opened":
            doc.update({
                ...
                "to_branch": to_branch,
                "message": f"<b>{author}</b> submitted a pull request from <b>{from_branch}</b> to <b>{to_branch}</b> on {readable_timestamp}"
        ...
        # MERGE event
            ...
            doc.update({
                ...
                "from_branch": from_branch,
                "to_branch": to_branch,
                "message": f"<b>{author}</b> merged branch <b>{from_branch}</b> to <b>{to_branch}</b> on {readable_timestamp}"
